...
var grammar = {
    ...
    {"name": "line", "symbols": ["title"]},
    {"name": "line", "symbols": ["newline", "newline", "list"], "postprocess": d => "<list>" + d[2] + "</list>"},
    {"name": "line", "symbols": ["string"], "postprocess": d => d[0]},
    {"name": "list", "symbols": ["newline", "newline"]},
    {"name": "list", "symbols": ["list", "element"], "postprocess": d => d[0] + "&emsp;" + d[1] + "<br>"},
    {"name": "element", "symbols": [{"literal":"-"}, "__", "string"]},
    {"name": "element", "symbols": ["int", {"literal":"."}, "__", "string"]},
    {"name": "title", "symbols": [{"literal":"#"}, "__", "string"], "postprocess": d => "<h1>" + d[2] + "</h1>"},
    {"name": "title$string$1", "symbols": [{"literal":"#"}, {"literal":"#"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "title", "symbols": ["title$string$1", "__", "string"], "postprocess": d => "<h2>" + d[2] + "</h2>"},
    ...
    {"name": "dbnewline", "symbols": ["newline", "newline"]},
    {"name": "newline", "symbols": [{"literal":"\n"}], "postprocess": emptyStr},
    {"name": "newline", "symbols": [{"literal":"\r"}], "postprocess": emptyStr}
]
  , ParserStart: "lines"
}
